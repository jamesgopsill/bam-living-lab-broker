...
const createApp = async (opts) => {
    ...
    if (exports.appConfig.ssl &&
        ["staging", "production"].includes(exports.appConfig.sslMode) &&
        !(0, node_fs_1.existsSync)(sslFile)) {
        /* Init client */
    ...
    if (exports.appConfig.ssl && exports.appConfig.sslMode === "local" && !(0, node_fs_1.existsSync)(sslFile)) {
        const attrs = [
            {
                name: "commonName",
                value: "localhost",
